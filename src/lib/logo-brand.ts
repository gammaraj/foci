...
/** Tagline color on dark surfaces — cyan-300, solid (readable on #0b1121). */
export const FOCI_TAGLINE_ON_DARK = "text-cyan-300";
/** Tagline color on light surfaces — cyan-700. */
export const FOCI_TAGLINE_ON_LIGHT = "text-cyan-700";
