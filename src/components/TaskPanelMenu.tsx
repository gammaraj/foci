  ...
  return (
    <div className="relative" ref={ref}>
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className={`inline-flex items-center gap-1 ${FOCUS_BAR_ICON_BTN}`}
        aria-label="Menu — import, settings, and more"
        title="Import, settings, projects…"
        aria-expanded={open}
      ...
      >
        ...
        <span className="hidden roomy:inline text-xs font-semibold pr-0.5">Menu</span>
      </button>
      {open && (
        <div
