  ...
  return (
    ...
    >
      ...
      <div className="app-container flex items-center gap-2 py-2.5">
        ...
        >
          <span className={`text-xl font-mono font-bold tabular-nums leading-none ${isRunning && !isBreak ? "text-cyan-600 dark:text-cyan-400" : isBreak ? "text-green-700 dark:text-green-300" : "text-slate-800 dark:text-slate-100"}`}>
            {displayTime}
          </span>
