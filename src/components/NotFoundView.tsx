    ...
    <div
      className={
        embedded
          ...
          : "flex min-h-screen flex-col items-center justify-center bg-slate-50 dark:bg-page px-4 py-12 text-center"
      }
    >
      <EmptyState
        titleAs="h1"
        title="Page not found"
        body="Beavy chewed through every link. Still no page — just woodchips."
        bodyClassName="text-lg max-w-md"
        illustration={
          <BusyBeaver
            alt="Beavy the Beaver looking lost"
            size={embedded ? 112 : 140}
            className="mb-2"
            priority
          />
        }
        action={
          <div className="mt-5 flex flex-wrap items-center justify-center gap-3">
            <ButtonLink href="/app/cards" size="lg">
