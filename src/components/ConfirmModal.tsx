  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed left-1/2 bottom-4 safe-bottom -translate-x-1/2 z-[9991] w-[calc(100vw-2rem)] max-w-sm max-h-[calc(100vh-2rem)] overflow-y-auto bg-white dark:bg-[#131d30] border border-slate-200 dark:border-[#243350] rounded-xl shadow-2xl p-5 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2"
      >
