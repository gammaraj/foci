...
export default function HomeAppMockup() {
  return (
    <div className="relative w-full max-w-5xl mx-auto overflow-hidden">
      <div className="rounded-t-2xl bg-slate-200/90 dark:bg-surface-hover px-4 py-3 flex items-center gap-2">
        ...
        <div className="flex-1 flex justify-center">
          <div className="bg-surface-elevated rounded-md px-4 py-1 text-xs text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-transparent">
            usefoci.com/app
          </div>
        </div>
      </div>

      <div className="rounded-b-2xl border border-surface-border border-t-0 overflow-hidden shadow-2xl shadow-black/20 dark:shadow-black/40 bg-[#0b1121]">
