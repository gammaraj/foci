        ...
        <ul className="space-y-2 mb-4">
          {SHORTCUTS.map((s) => (
            <li key={s.keys} className="flex items-center justify-between gap-3 text-sm">
              ...
              <kbd className="px-2 py-0.5 rounded-md bg-slate-100 dark:bg-[#1a2d4a] border border-slate-200 dark:border-[#243350] text-xs font-semibold tabular-nums text-slate-700 dark:text-slate-200">
                {s.keys}
              </kbd>
            </li>
          ))}
