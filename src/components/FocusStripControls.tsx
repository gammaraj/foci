...
export const FOCUS_STRIP_CHIP =
  "inline-flex items-center h-7 rounded-md border border-surface-border dark:border-surface-border bg-surface-elevated/70 dark:bg-white/[0.04] text-xs font-medium text-slate-600 dark:text-slate-300 hover:bg-surface-muted dark:hover:bg-white/[0.08] hover:text-slate-900 dark:hover:text-white transition-colors";
...
export const FOCUS_STRIP_CHIP_FRAME =
  "inline-flex items-center h-7 rounded-md border border-surface-border dark:border-surface-border bg-surface-elevated/70 dark:bg-white/[0.04]";
