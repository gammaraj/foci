...
export const viewport: Viewport = {
  ...
  viewportFit: "cover",
  themeColor: [
    { media: "(prefers-color-scheme: light)", color: "#c2d0e6" },
...
const bootCriticalStyle = `.foci-boot{position:fixed;inset:0;z-index:99999;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.75rem;background:#c2d0e6;color:#334155;font-family:system-ui,-apple-system,sans-serif}.dark .foci-boot,html.dark .foci-boot{background:#070b16;color:#e2e8f0}.foci-boot-mark{font-size:1.75rem;font-weight:700;letter-spacing:-.02em}.foci-boot-msg{font-size:.95rem;opacity:.72}#foci-offline-fallback{display:none}html.foci-offline-fallback .foci-boot{display:none!important}html.foci-offline-fallback #foci-offline-fallback{display:block;position:fixed;inset:0;z-index:99998;overflow:auto;background:#c2d0e6;color:#0f172a;padding:calc(20px + env(safe-area-inset-top)) 18px 28px;font-family:system-ui,-apple-system,sans-serif}html.dark.foci-offline-fallback #foci-offline-fallback{background:#070b16;color:#e2e8f0}#foci-offline-fallback h1{font-size:1.5rem;margin:0 0 .35rem}#foci-offline-fallback .note{color:#64748b;font-size:.875rem;margin:0 0 1.1rem}html.dark #foci-offline-fallback .note{color:#94a3b8}#foci-offline-fallback ul{list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px}#foci-offline-fallback li{background:#fff;border-radius:14px;padding:12px 14px}html.dark #foci-offline-fallback li{background:#132037}#foci-offline-fallback li.done{opacity:.55;text-decoration:line-through}`;
